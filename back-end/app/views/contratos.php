...
<body>
    ...
    <section>
        <div class="title">CONTRATOS DE <?= date("d/m/Y",$_GET['data-inicial']) ?> ATÉ <?=date("d/m/Y",$_GET['data-final'])?></div>
        <div class="tabela">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=date("d/m/Y", strtotime($campo->data_embarque_inicial));?></td>
                    <td><?=date("d/m/Y", strtotime($campo->data_embarque_final));?></td>
                    <td><?=$campo->preco;?></td>
