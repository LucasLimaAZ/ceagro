        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=date("d/m/Y", strtotime($contrato_vendedor->data_embarque_inicial));?></td>
                    <td><?=date("d/m/Y", strtotime($contrato_vendedor->data_embarque_final));?></td>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=date("d/m/Y", strtotime($contrato_comprador->data_embarque_inicial));?></td>
                    <td><?=date("d/m/Y", strtotime($contrato_comprador->data_embarque_final));?></td>
